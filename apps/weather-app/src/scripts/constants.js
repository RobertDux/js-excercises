...
export const API_ERROR_DEFAULT =
  "Something went wrong when retrieving weather data.";

export const GEO_ERROR_PERMISSION =
...
export const GEO_ERROR_DEFAULT =
  "Determining your location failed, please try again.";

export const INVALID_CITY_ERROR = "Please enter a valid city.";
export const MAX_LOCATIONS_EXCEEDED_ERROR =
  "Maximum amount of locations reached.";
